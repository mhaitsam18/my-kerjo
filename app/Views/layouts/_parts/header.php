                        ...
                        <div class="dropdown-user-scroll scrollbar-outer">
                            <li>
                                <div class="user-box">
                                    <div class="avatar-lg">
                                        <?php if (session()->get("pas_foto") !== "default.jpg") : ?>
                                            <img src="<?= base_url("uploads/pas_foto/" . session()->get("pas_foto")) ?>" alt="image profile" class="avatar-img rounded">
                                        <?php else : ?>
                                            <img src="<?= base_url("uploads/pas_foto/default.jpg") ?>" alt="image profile" class="avatar-img rounded">
                                        <?php endif; ?>
                                    </div>
                                    <div class="u-text">
                            ...
                            <li>
                                ...
                                <a class="dropdown-item text-danger" href="<?= base_url("logout"); ?>">Keluar</a>
                            </li>
                        </div>
                    </ul>
                </li>
