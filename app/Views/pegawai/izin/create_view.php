                ...
                <div class="card">
                    <div class="card-body">
                        <div class="alert-warning p-2">
                            ...
                            <p>Durasi izin yang diperbolehkan maksimal 5 hari, dan anda hanya dapat melakukan permohonan izin satu kali dalam satu bulan</p>
                        </div>

                        <form action="<?= base_url("pegawai/permohonan-izin/simpan"); ?>" method="POST" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            ...
                            <div class="form-group">
                                <label for="tanggal_mulai">Tanggal Mulai izin</label>
                            ...
                            <div class="form-group">
                                ...
                                <a href="<?= base_url("pegawai/permohonan-izin") ?>" class="btn btn-warning">Batalkan</a>
                            </div>
                        </form>
                    </div>
                </div>
