                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <form action="<?= base_url("pegawai/profile/update-profile"); ?>" method="POST" enctype="multipart/form-data">
                                    <?= csrf_field(); ?>
                                    <div class="form-group">
                                        <label for="nik">NIK</label>
                                        <input type="text" name="nik" id="nik" class="form-control <?= ($validation->hasError("nik")) ? "is-invalid" : ""; ?>" placeholder="Nama Lengkap" value="<?= session()->get("nik") ?>">
            ...
            <div class="col-sm-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url("pegawai/profile/ganti-password"); ?>" method="POST">
                            <?= csrf_field(); ?>
                            <div class="form-group">
